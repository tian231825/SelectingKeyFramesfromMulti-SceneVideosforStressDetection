...
from VQE.insightface.src import face_preprocess
# Insightface imports
from VQE.insightface.src import mtcnn_detector
import torch
...
class SER_FIQ:
    ...
    def __init__(self,
                 gpu=0,  # Which gpu should be used -> gpu id
                 det=0,  # Mtcnn option, 1= Use R+O, 0=Detect from beginning
                 ):
        """
        ...
        #     "./VQE/insightface/model/insightface-symbol.json",
        #     ['data'],
        #     "./VQE/insightface/model/insightface-0000.params",
        #     ctx=mx.gpu(gpu)
        # )
        ...
        # self.detector = mtcnn_detector.MtcnnDetector(model_folder="./VQE/insightface/mtcnn-model/",
        #                                              ctx=self.device,
        #                                              num_worker=1,
    ...
    def apply_mtcnn(self, face_image):
        """
    ...
    def get_score(self, aligned_img, T=100, alpha=130.0, r=0.88):
        """
        ...
        gpu_repeated = torch.tensor(repeated).to(self.device)

        # TODO
        # X = self.insightface(gpu_repeated).asnumpy()
        # X = self.insightface(np.array(gpu_repeated.cpu()))
